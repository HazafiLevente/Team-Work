...
const CATEGORY_ALIASES = {
    ...
    computer: ["computer", "computers", "pc", "pcs", "processors", "video_cards", "ram", "storage", "psu", "motherboard", "cpu"],
    ht: ["ht", "home theater", "home_theater", "home-theater", "receiver", "receivers", "speaker", "speakers", "subwoofer", "audio_processor"],
    instrument: ["instrument", "instruments", "drum", "guitar", "trumpet", "saxophone"],
};
